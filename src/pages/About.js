    ...
    <div id='about'>
      <div id='about-content'>
        ...
        <p>
          ...
          highlights my individual experiences - each page mirroring the theme of the project. I also made a page to show the<Link to='/MentalHealthApp' id='nested-link'>UI Designs</Link> that I made for fun! 
